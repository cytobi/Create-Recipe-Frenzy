package de.simonklausner.createrecipefrenzy;
...
@Mod(CreateRecipeFrenzy.MODID)
public class CreateRecipeFrenzy {
    // Define mod id in a common place for everything to reference
    public static final String MODID = "createrecipefrenzy";
    // Directly reference a slf4j logger
    public static final Logger LOGGER = LogUtils.getLogger();
    // Create a Deferred Register to hold Blocks which will all be registered under the "createrecipefrenzy" namespace
    ...
    // Creates a new food item with the id "createrecipefrenzy:example_id", nutrition 1 and saturation 2
    ...
    public CreateRecipeFrenzy(IEventBus modEventBus, ModContainer modContainer) {
        ...
        // Note that this is necessary if and only if we want *this* class (CreateRecipeFrenzy) to respond directly to events.
